...
- `npm run test` - ユニットテスト & インテグレーションテスト & ビルド & E2Eテスト
- `npm run test:e2e` - ビルド & E2Eテスト
- `npm run test:unit` - ユニットテスト & インテグレーションテスト
- `npm run tscheck` - 型チェック
...
- 全関数の説明を JSDoc で記述
- 純粋ロジック / ブラウザ副作用（非DOM） / DOM/UI で関数をまとめた上で並び順を適用する
