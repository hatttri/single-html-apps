...
| アプリ名                                                                            | 説明                                                      |
| ----------------------------------------------------------------------------------- | --------------------------------------------------------- |
| [Random Picker](https://hatttri.github.io/single-html-apps/apps/random-picker.html) | 改行区切りで入力したテキストからランダムで1つを選ぶツール |

## 使い方

1. このリポジトリをクローンまたはダウンロードします。
2. `apps/` 配下の `.html` ファイルをブラウザ（Chrome, Edge, Safari, Firefoxなど）で開いてください。
